...
figurines-cargotech-8 = Почта никогда не прекращается...
figurines-cargotech-9 = Ничто не остановит почту!
figurines-cargotech-10 = Запрос на маску клоуна? Хорошо, дай-ка найду оружие...
figurines-cargotech-11 = Запрос на лазеры? Никто не заметит, если мы доставим тренировочные, так ведь?
...
figurines-chemist-7 = Вот и таблетки!
...
figurines-lawyer-6 = Мой клиент не виноват!
...
figurines-AI-5 = Попробуй сменить мои законы и увидишь что будет.
...
figurines-wizard-8 = Пушки для лузеров, которые не умеют взрывть людей силой мысли.
