...
ent-JetInjector = реактивный инъектор
    .desc = Стерильный инъектор для удобного введения медицины пациентам.
ent-AdvancedJetInjector = продвинутый реактивный инъектор
    .desc = Безупречный, модный инъектор высокого качества. Позволяет ещё быстрее делать инъекции с немного увеличенной вместительностью.
