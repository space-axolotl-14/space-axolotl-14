...
ent-WizardsGrimoire = гримуар волшебника
    .suffix = Волшебник
    .desc = Тяжёлый том, содержащий сложные таинственные формулы для подготовки магических заклинаний и призыва сверхъестественного снаряжения. Десятилетия ушли на изучение этой коллекции мистических секретов. Теперь испорьте с их помощью чей-то день.
