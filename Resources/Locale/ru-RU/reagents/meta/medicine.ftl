...
reagent-desc-warfarin = Обычно используется в качестве антикоагулянта. Затрудняет свёртываемость крови. При передозировке может вызвать внутреннее кровотечение.
